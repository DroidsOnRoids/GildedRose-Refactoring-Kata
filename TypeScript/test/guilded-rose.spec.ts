...
describe("Gilded Rose", function () {
  it("should foo", function () {
    const gildedRose = new Crap(
      new DailyGildedRoseInventory([new Item("foo", 0, 0)])
    );
  ...
  describe("updateQuality()", function () {
    it("decreases sell in value", () => {
      const gildedRose = new Crap(
        new DailyGildedRoseInventory([new Item("foo", 5, 5)])
      );
      const items = gildedRose.updateQuality();
      expect(items[0].sellIn).to.equal(4);
    });
    ...
    describe("sell in is zero", () => {
      const gildedRose = new Crap(
        new DailyGildedRoseInventory([new Item("foo", 0, 5)])
      );
    ...
    describe("for aged Brie", () => {
      it('"Aged Brie" actually increases in Quality the older it gets', () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([AgedBrieFactory(10, 10)])
        );
        const items = gildedRose.updateQuality();
      ...
      it("increases quality even after sell in date", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([AgedBrieFactory(10, 0)])
        );
        const items = gildedRose.updateQuality();
        expect(items[0].quality).to.equal(11);
      });
      ...
      it("The Quality of an item is never more than 50", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([AgedBrieFactory(50, 50)])
        );
        const items = gildedRose.updateQuality();
    ...
    describe("for sulfuras", () => {
      it("being a legendary item, never has to be sold or decreases in Quality", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([new Item(sulfuras, 10, 10)])
        );
        const items = gildedRose.updateQuality();
    ...
    describe('"Backstage passes", like aged brie, increases in Quality as its SellIn value approaches', () => {
      it("quality increases by 1", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([new Item(backstage, 20, 20)])
        );
        const items = gildedRose.updateQuality();
      ...
      it("quality increases by 2 when there are 10 days or less", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([new Item(backstage, 10, 10)])
        );
        const items = gildedRose.updateQuality();
      ...
      it("quality increases by 3 when there are 5 days or leess", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([new Item(backstage, 5, 5)])
        );
        const items = gildedRose.updateQuality();
      ...
      it("Quality drops to 0 after the concert", () => {
        const gildedRose = new Crap(
          new DailyGildedRoseInventory([new Item(backstage, 0, 5)])
        );
        const items = gildedRose.updateQuality();
        expect(items[0].quality).to.equal(0);
      });
